...
test('schedule.build', () => {
    ...
    const expected = [
        ...
        createScheduleData(1, 'debt 0', startDate.plusDays(14 * 1), '1000.00', '1000.00', '0.00'),
        createScheduleData(2, 'debt 1', startDate.plusDays(14 * 2), '2000.00', '1000.00', '1000.00'),
        createScheduleData(3, 'debt 1', startDate.plusDays(14 * 3), '1000.00', '1000.00', '0.00'),
        createScheduleData(4, 'debt 2', startDate.plusDays(14 * 4), '2000.00', '1000.00', '1000.00'),
        createScheduleData(5, 'debt 2', startDate.plusDays(14 * 5), '1000.00', '1000.00', '0.00')
    ];
...
test('schedule.buildForDebt', () => {
    ...
    const expected = [
        ...
        createScheduleData(1, 'debt 0', startDate.plusDays(14 * 1), '750.00', '250.00', '500.00'),
        createScheduleData(2, 'debt 0', startDate.plusDays(14 * 2), '500.00', '250.00', '250.00'),
        createScheduleData(3, 'debt 0', startDate.plusDays(14 * 3), '250.00', '250.00', '0.00')
    ];
...
function createScheduleData(rank, name, date, previousBalance, amount, nextBalance) {
    return {
        rank: rank,
        name: name,
        date: date,
